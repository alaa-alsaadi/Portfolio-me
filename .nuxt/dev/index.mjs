...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getRequestProtocol, getRequestHost, createError, getQuery as getQuery$1, removeResponseHeader, readBody, setHeader, getHeader, getResponseStatus, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, sendError, getResponseStatusText, H3Error } from 'file://D:/Portfolio-me/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/Portfolio-me/node_modules/@vue/shared/dist/shared.cjs.js';
import defu, { defuFn, defu as defu$1, createDefu } from 'file://D:/Portfolio-me/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file://D:/Portfolio-me/node_modules/satori-html/dist/index.js';
import sizeOf from 'file://D:/Portfolio-me/node_modules/image-size/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withLeadingSlash, withBase, withTrailingSlash, withoutLeadingSlash, decodePath, joinRelativeURL, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file://D:/Portfolio-me/node_modules/ufo/dist/index.mjs';
import consola, { createConsola, consola as consola$1 } from 'file://D:/Portfolio-me/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file://D:/Portfolio-me/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file://D:/Portfolio-me/node_modules/playwright-core/index.mjs';
import { toValue, isVNode, isRef } from 'file://D:/Portfolio-me/node_modules/vue/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/Portfolio-me/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parse, stringify, uneval } from 'file://D:/Portfolio-me/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/Portfolio-me/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file://D:/Portfolio-me/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file://D:/Portfolio-me/node_modules/unstorage/drivers/lru-cache.mjs';
import { klona } from 'file://D:/Portfolio-me/node_modules/klona/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://D:/Portfolio-me/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/Portfolio-me/node_modules/scule/dist/index.mjs';
import { createGenerator } from 'file://D:/Portfolio-me/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file://D:/Portfolio-me/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { digest, hash as hash$1 } from 'file://D:/Portfolio-me/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Portfolio-me/node_modules/radix3/dist/index.mjs';
import { createHooks } from 'file://D:/Portfolio-me/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/Portfolio-me/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/Portfolio-me/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Portfolio-me/node_modules/unstorage/drivers/fs.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file://D:/Portfolio-me/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/Portfolio-me/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/Portfolio-me/node_modules/source-map/source-map.js';
import devalue from 'file://D:/Portfolio-me/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/Portfolio-me/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/Portfolio-me/node_modules/errx/dist/index.js';
import fs, { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file://D:/Portfolio-me/node_modules/pathe/dist/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/Portfolio-me/node_modules/unhead/dist/plugins.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file://D:/Portfolio-me/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file://D:/Portfolio-me/node_modules/unhead/dist/utils.mjs';
import Fuse from 'file://D:/Portfolio-me/node_modules/fuse.js/dist/fuse.mjs';
import { diffLines } from 'file://D:/Portfolio-me/node_modules/diff/libesm/index.js';
import MagicString from 'file://D:/Portfolio-me/node_modules/magic-string/dist/magic-string.es.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/Portfolio-me/node_modules/ipx/dist/index.mjs';
import { createUnhead } from 'file://D:/Portfolio-me/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file://D:/Portfolio-me/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file://D:/Portfolio-me/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"D:/Portfolio-me/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"D:/Portfolio-me/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Portfolio-me","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/Portfolio-me/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Portfolio-me/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/Portfolio-me/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/Portfolio-me/.data/kv"}));
...
const _tmeUhsff9bBcHC_9taC5xNjhN2HMiK16YCEyVR4mlM = (function(nitro) {
...
const _2o28HrW_C1CdpCezjRXzGF2lNZwOyQILcJtUn2PWQoU = (nitroApp) => {
...
const plugins = [
  _tmeUhsff9bBcHC_9taC5xNjhN2HMiK16YCEyVR4mlM,
...
_2o28HrW_C1CdpCezjRXzGF2lNZwOyQILcJtUn2PWQoU
];
...
const getServerEntry = () => import('file://D:/Portfolio-me/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://D:/Portfolio-me/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _hIljBO = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _sZkOfz = defineEventHandler(async (e) => {
...
const _8jx_1S = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file://D:/Portfolio-me/node_modules/fast-xml-parser/src/fxp.js');
...
const _QDznkT = defineEventHandler(async (e) => {
...
const _r8owj7 = defineEventHandler(async (e) => {
...
const _1rKatj = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _GEzsYJ = defineEventHandler(async (e) => {
  return {
...
const _wmivWi = defineEventHandler(async (e) => {
...
const _WlLTXJ = defineEventHandler(async (e) => {
...
const _lazy_akiDu7 = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_VWAOoZ = () => Promise.resolve().then(function () { return font$1; });
const _lazy_b1CUYh = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_rxwai4 = () => Promise.resolve().then(function () { return image$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _hIljBO, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/__robots__/debug.json', handler: _sZkOfz, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _8jx_1S, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _QDznkT, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/__link-checker__/inspect', handler: _r8owj7, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _1rKatj, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _GEzsYJ, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_VWAOoZ, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_b1CUYh, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/__schema-org__/debug.json', handler: _wmivWi, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _WlLTXJ, lazy: false, middleware: true, method: undefined },
  { route: '/_ipx/**', handler: _M4QR0w, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_akiDu7, lazy: true, middleware: false, method: undefined },
