...
export const AchievementsSection: typeof import("../components/AchievementsSection.vue").default
export const ActivityVisualization: typeof import("../components/ActivityVisualization.vue").default
export const ContactSection: typeof import("../components/ContactSection.vue").default
export const DashboardFooter: typeof import("../components/DashboardFooter.vue").default
export const DashboardNav: typeof import("../components/DashboardNav.vue").default
export const ExperienceSection: typeof import("../components/ExperienceSection.vue").default
export const HeroSection: typeof import("../components/HeroSection.vue").default
export const MetricsDisplay: typeof import("../components/MetricsDisplay.vue").default
export const ProjectsSection: typeof import("../components/ProjectsSection.vue").default
export const SkillsVisualization: typeof import("../components/SkillsVisualization.vue").default
...
export const LazyAchievementsSection: LazyComponent<typeof import("../components/AchievementsSection.vue").default>
export const LazyActivityVisualization: LazyComponent<typeof import("../components/ActivityVisualization.vue").default>
export const LazyContactSection: LazyComponent<typeof import("../components/ContactSection.vue").default>
export const LazyDashboardFooter: LazyComponent<typeof import("../components/DashboardFooter.vue").default>
export const LazyDashboardNav: LazyComponent<typeof import("../components/DashboardNav.vue").default>
...
export const LazyMetricsDisplay: LazyComponent<typeof import("../components/MetricsDisplay.vue").default>
export const LazyProjectsSection: LazyComponent<typeof import("../components/ProjectsSection.vue").default>
export const LazySkillsVisualization: LazyComponent<typeof import("../components/SkillsVisualization.vue").default>
