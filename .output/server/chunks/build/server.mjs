import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, inject, computed, unref, defineAsyncComponent, shallowRef, hasInjectionContext, getCurrentInstance, createElementBlock, provide, cloneVNode, h, Suspense, nextTick, mergeProps, shallowReactive, ref, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, toValue, getCurrentScope, watch, withCtx, useSSRContext } from 'vue';
import { l as createError$1, S as headSymbol, T as defu, U as hasProtocol, V as isScriptProtocol, W as joinURL, X as withQuery, Y as useHead$1, Z as sanitizeStatusCode, _ as getContext, $ as $fetch, a0 as baseURL, a1 as createHooks, a2 as executeAsync, a3 as withoutTrailingSlash, a4 as titleCase, a5 as toRouteMatcher, a6 as createRouter$1, a7 as camelCase, H as withTrailingSlash, M as parseURL, a8 as withoutBase, a9 as useSeoMeta$1, aa as stringifyQuery, ab as withLeadingSlash, ac as withBase, ad as resolveUnrefHeadInput } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cfkq23Hd.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-CL9c61tO.mjs')
  }
];
...
const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-CYqI5ytk.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CxhxRnXy.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-H8TCBfZr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BsNJB-ZA.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-1SsJF8V9.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export { _export_sfc as _, __nuxt_component_0 as a, useNuxtApp as b, createError as c, useRuntimeConfig as d, entry_default as default, useRequestEvent as e, useRouter as f, nuxtLinkDefaults as g, useOgImageRuntimeConfig as h, injectHead as i, useSiteConfig as j, navigateTo as n, resolveRouteObject as r, useHead as u };
