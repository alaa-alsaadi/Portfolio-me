import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { y as prefixStorage, z as useStorage, A as useNitroOrigin, B as emojiCache, C as useOgImageRuntimeConfig, l as createError, D as fetchIsland, E as createHeadCore, F as normaliseFontInput, G as theme, H as withTrailingSlash, k as getQuery, I as handleCacheHeaders, J as setHeaders, K as setHeader, L as hash, M as parseURL, N as setResponseHeader, O as proxyRequest, P as sendRedirect, Q as resolveContext, R as H3Error } from './nitro.mjs';
